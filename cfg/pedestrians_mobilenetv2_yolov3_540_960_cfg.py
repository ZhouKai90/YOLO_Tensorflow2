...
__C.TRAIN.EPOCHS              = 50
__C.TRAIN.CKPT_DIR            = 'save/pedestrian/ckpt/mobilenetv2_yolov3_540_960/'
__C.TRAIN.LOG_DIR             = 'save/pedestrian/tensorboard/mobilenetv2_yolov3_540_960/'
__C.TRAIN.CONTINUE_EPOCH      = 0
__C.TRAIN.PRETRAIN            = None
__C.TRAIN.PRETRAIN            = 'save/pedestrian/ckpt/mobilenetv2_yolov3_540_960/model_epoch30'
