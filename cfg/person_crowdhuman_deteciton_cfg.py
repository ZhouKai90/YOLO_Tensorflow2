...
__C.YOLO.ANCHORS                = "data/anchors/person_crowdhuman_540_960_9_anchors.txt"
...
__C.DATASET.TRAIN_ANNOT       = __C.DATASET.PATH + "person_train.txt"
__C.DATASET.TEST_ANNOT         = __C.DATASET.PATH + "person_val.txt"
...
__C.TRAIN.EPOCHS              = 50
__C.TRAIN.CKPT_DIR            = 'save/pedestrian/ckpt/peleenet_yolov3_540_960/'
__C.TRAIN.LOG_DIR             = 'save/pedestrian/tensorboard/peleenet_yolov3_540_960/'
...
__C.TEST.CKPT                 = 'save/head/ckpt/peleenet_yolov3_540_960/model_final'
