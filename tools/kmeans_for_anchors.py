...
def load_data(annotation_path, target_size=None):
...
if __name__ == '__main__':
    ...
    anchors_num = 9
    # 载入数据集，可以使用VOC的xml
    path = r'data/dataset/crowd_human/person_train.txt'
    anchor_file = r'data/anchors/person_crowdhuman_540_960_9_anchors'
